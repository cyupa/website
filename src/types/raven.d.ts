...
// DOVETAIL EDIT: add `| undefined`; rationale is raven is loaded asynchronously
// (defer) so may come late or not at all (e.g. script blocking, offline, etc),
// so it can't be safely assumed to be present.
declare var Raven: Raven.RavenStatic | undefined;

// DOVETAIL EDIT: comment out next line
// export = Raven;
...
declare namespace Raven {
  ...
  interface RavenStatic {
    ...
    /*
        ...
        * @return {Raven}
        */
    setUserContext(user?: { [key: string]: string | number | boolean | null | void }): RavenStatic;
